...
export default function Navbar({
    ...
    return (
        <nav className="sticky top-0 z-50 border-b border-neutral-100 bg-white/80 shadow-sm backdrop-blur-md">
            <MaxWidthWrapper className="grid h-20 grid-cols-[1fr_auto_1fr] items-center md:grid md:grid-cols-[1fr_auto_1fr]">
                ...
                <div className="order-2 w-full md:order-0 md:justify-self-start">
                    <Link href="/">
                        <Image
                            src="/LogoNoBg.png"
                            width={100}
